...
//                 <p className="text-sm text-gray-700">weight: N/A</p>
//                 <p>
//                   Qty:
//                   <select
//                     className="bg-transparent outline-none px-0 mx-0"
...
//               </div>
//             </div>
//             <div className="h-28 w-28 flex items-center justify-center font-semibold">
